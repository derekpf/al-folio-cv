...
class DateSortingTest < Minitest::Test
  ...
  def test_formats_compact_month_year_dates
    assert_equal "04/26", AlFolioCv::DateSorting.format("2026-04")
    assert_equal "08/26", AlFolioCv::DateSorting.format("2026-08-01")
  ...
  def test_date_format_filter_is_registered_with_liquid
    ...
    assert_equal "08/25", template.render("value" => "2025-08")
  end
